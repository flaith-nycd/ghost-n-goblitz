...
;special thanks:
; . Syntax_Error for helping me with jump function
;==================================================================
...
;	Select Knight\Status
;		Case WALKING
;			If KeyHit(Left_Alt) Knight\Status=JUMPING
;			If zombie_hits_knight Knight\Status=DIED
;		Case JUMPING
;			If collided_with_ground Knight\Status=WALKING
;		Case DIED
;			blah ...
;	End Select
	...
	;================================
	;;;If firstjump = 0 Then 
	Collide = CheckKnightCollide(knight\PosX+xscroll,Knight\PosY)
	If Collide=4 And Knight\Jumping
		Knight\Jumping=0
	...
	;================================
	If RestOfTime <= 0 Then GameOver()									;on a dépassé le temps imparti
...
Function jump()
	If firstjump = 0 Then
		knight\PosY = knight\PosY + jumpheight
		jumpheight=jumpheight+Gravity
		knight\jumping = 1
	EndIf 
	If knight\PosY <= knight\OldPosY - 70 Then firstjump = 1			; saut maxi 80 pixels
End Function
